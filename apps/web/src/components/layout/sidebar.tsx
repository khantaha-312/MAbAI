    ...
    <aside className=" flex flex-col justify-between">
      ...
      <div className="space-y-6 ">
        ...
        <nav className="space-y-1">
            <NavItem href="/onboarding/dashboard" icon={<LayoutDashboard size={18} />} label="Dashboard" active />

            <NavItem href="/onboarding/markets" icon={<TrendingUp size={18} />} label="Markets" />

            <NavItem href="/onboarding/watchlist" icon={<Bookmark size={18} />} label="Watchlist" />

            <NavItem href="/onboarding/analytics" icon={<BarChart2 size={18} />} label="Analytics" />

            <NavItem href="/onboarding/alerts" icon={<Bell size={18} />} label="Alerts" />

            <NavItem href="/onboarding/reports-history" icon={<FileText size={18} />} label="Reports" />
        </nav>
...
function NavItem({ 
  ...
  active?: boolean;
    ...
    return (
        ...
        <Link href={href} className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold transition-all ${
